# API docs for Vue Storefront Bridge

Vue Storefront bridge is designed to export the data in the format that [vue-storefront](github.com/DivanteLtd/vue-storefront) can consume. 
